...
// Include your function prototype
__declspec(dllexport) int quantum_table_index(short int Ns, short int player1position, short int player2position, char graph[], bool check_first);

// Function definition (copy your function code here)
__declspec(dllexport) int quantum_table_index(short int Ns, short int player1position, short int player2position, char graph[], bool check_first) {
